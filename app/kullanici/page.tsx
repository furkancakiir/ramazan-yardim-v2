...
export default async function KullaniciDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Kayıtlarım</h1>
          <p className="text-gray-600 mt-1">
            {profile?.mahalleler?.ad ? `${profile.mahalleler.ad} Mahallesi` : 'Mahalle bilgisi yok'}
          </p>
        </div>
        <Link
          href="/kullanici/yeni-kayit"
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-3xl font-bold text-green-600">
            {kayitlar?.filter(k => {
              ...
              const kayitDate = new Date(k.created_at).toDateString()
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">Tüm Kayıtlarım</h2>
        </div>
